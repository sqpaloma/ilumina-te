    ...
    <footer className="bg-white text-stone-800 py-16 px-4 md:px-6">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 border-b border-stone-200 pb-12">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-4">
          ...
          <h2 className="text-3xl font-semibold text-[#705C4E]">ilumina-te</h2>
          <p className="text-stone-600 text-sm leading-relaxed max-w-xs">
            Um universo de bem-estar, autocuidado e conexão com o sagrado que habita em você.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="bg-blue-500 text-white text-xs px-2 py-0.5 rounded-full">EM BREVE</span>
          </div>
          <a href="#" className="text-stone-600 hover:text-amber-600 transition-colors text-sm">
            Projetos
          </a>
          <div className="flex items-center gap-2">
            ...
            <span className="bg-blue-500 text-white text-xs px-2 py-0.5 rounded-full">CONTRATANDO</span>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-3">
          ...
          <p className="flex items-start gap-2 text-stone-600 text-sm">
            <MapPin className="w-4 h-4 mt-1" /> Rua Melo Palheta, 172 - Água Branca <br /> Salvador - BA, 05002-030
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between pt-8 space-y-4 md:space-y-0">
        <p className="text-sm text-stone-500">
          Copyright &copy; {new Date().getFullYear()} ilumina-te. Todos os direitos reservados.
        </p>
